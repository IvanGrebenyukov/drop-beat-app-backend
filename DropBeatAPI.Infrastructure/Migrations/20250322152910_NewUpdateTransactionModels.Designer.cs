...
namespace DropBeatAPI.Infrastructure.Migrations
{
    ...
    [Migration("20250322152910_NewUpdateTransactionModels")]
    partial class NewUpdateTransactionModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DropBeatAPI.Core.Entities.Transaction", b =>
                {
                    b.HasOne("DropBeatAPI.Core.Entities.Purchase", "Purchase")
                        .WithOne("Transaction")
                        .HasForeignKey("DropBeatAPI.Core.Entities.Transaction", "PurchaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
