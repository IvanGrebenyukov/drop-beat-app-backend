        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Beats_AspNetUsers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BeatGenres", x => new { x.BeatId, x.GenreId });
                    table.ForeignKey(
                        name: "FK_BeatGenres_Beats_BeatId",
                        column: x => x.BeatId,
                        principalTable: "Beats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BeatGenres_Genres_GenreId",
                        column: x => x.GenreId,
                        principalTable: "Genres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BeatLikes", x => new { x.UserId, x.BeatId });
                    table.ForeignKey(
                        name: "FK_BeatLikes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BeatLikes_Beats_BeatId",
                        column: x => x.BeatId,
                        principalTable: "Beats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BeatMoods", x => new { x.BeatId, x.MoodId });
                    table.ForeignKey(
                        name: "FK_BeatMoods_Beats_BeatId",
                        column: x => x.BeatId,
                        principalTable: "Beats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BeatMoods_Moods_MoodId",
                        column: x => x.MoodId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BeatTags", x => new { x.BeatId, x.TagId });
                    table.ForeignKey(
                        name: "FK_BeatTags_Beats_BeatId",
                        column: x => x.BeatId,
                        principalTable: "Beats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BeatTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartItems", x => new { x.CartId, x.BeatId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BeatGenres_GenreId",
                table: "BeatGenres",
                column: "GenreId");

            migrationBuilder.CreateIndex(
                name: "IX_BeatLikes_BeatId",
                table: "BeatLikes",
                column: "BeatId");

            migrationBuilder.CreateIndex(
                name: "IX_BeatMoods_MoodId",
                table: "BeatMoods",
                column: "MoodId");

            migrationBuilder.CreateIndex(
                name: "IX_BeatTags_TagId",
                table: "BeatTags",
                column: "TagId");
